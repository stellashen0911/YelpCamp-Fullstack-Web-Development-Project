...
router.get('/:id/edit', isLoggedIn, catchAsyn(async (req, res, next) => {
...
router.put('/:id', isLoggedIn, validateCampground, catchAsyn(async (req, res) => {
    const { id} = req.params;
...
router.delete('/:id', isLoggedIn, catchAsyn(async (req, res) => {
    const {id} = req.params;
